...
import { JPDepositInvalidCredentials, liveJPDepositValidCredentials} from "../stringHolders/jpDepositCredentials"
...
import { jpDepositErrorMessage } from "../stringHolders/errorMessage"
 ...
 const login = new LoginTest()
  let emailAddress = validloginCredentials.liveEmailAddress
  let merchantName = liveJPDepositValidCredentials.liveValidMerchantName
  let password = validloginCredentials.livePassword
  ...
  let accountNumber = liveJPDepositValidCredentials.liveValidAccountNumber
  let invalidAccountNumber = JPDepositInvalidCredentials.stageInvalidAccountNumber
  let transferID = liveJPDepositValidCredentials.liveValidTransferID
  let uid =liveJPDepositValidCredentials.liveValidUID
  let amount = liveJPDepositValidCredentials.liveValidAmount
  let jpy = liveJPDepositValidCredentials.liveJPYCurrency
  let usd = liveJPDepositValidCredentials.liveUSDCurrency
  let gbp = liveJPDepositValidCredentials.liveGBPCurrency
  let eur = liveJPDepositValidCredentials.liveEURCurrency
  let php = liveJPDepositValidCredentials.livePHPCurrency
  let paymentIDFilter = liveJPDepositValidCredentials.liveSearchPaymentID
  let txnNumberFilter = liveJPDepositValidCredentials.liveSearchTxnNumber
  let merchantNumberFilter = liveJPDepositValidCredentials.liveSearchMerchantNumber
  let merchantNameFilter = liveJPDepositValidCredentials.liveSearchMerchantName
  let UIDFilter =liveJPDepositValidCredentials.liveSearchUID
  let transferIDFilter = liveJPDepositValidCredentials.liveSearchTransferID
  let merchantTXNFilter = liveJPDepositValidCredentials.liveSearchMerchantTXN
  let adminNotes = liveJPDepositValidCredentials.liveAdminNotes
  ...
  let invalidUID = JPDepositInvalidCredentials.liveInvalidUID
  let completedFilter = liveJPDepositValidCredentials.liveCompletedStatus
  let forConfirmationFilter = liveJPDepositValidCredentials.liveForConfirmationStatus
  let yesCallbackFilter = liveJPDepositValidCredentials.liveYesCallbackStatus
  let noCallbackFilter = liveJPDepositValidCredentials.liveNoCallbackStatus
  let manualAPIFilter = liveJPDepositValidCredentials.liveManualAPIType
  let autoAPIFilter = liveJPDepositValidCredentials.liveAutoAPIType
